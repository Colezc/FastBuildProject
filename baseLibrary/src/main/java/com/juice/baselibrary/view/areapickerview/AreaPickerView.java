...
public class AreaPickerView extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        provinceAdapter = new ProvinceAdapter(R.layout.item_dialog_address, addressBeans);
        ...
        provinceAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull BaseQuickAdapter adapter, @NonNull View view, int position) {
                ...
                if (strings.size() == 1) {
                    strings.add(context.getResources().getString(R.string.please_choose));
                } else if (strings.size() > 1) {
                    if (position != oldProvinceSelected) {
                        strings.set(1, context.getResources().getString(R.string.please_choose));
                        if (strings.size() == 4) {
                            strings.remove(3);
                        }
                    }
                ...
                areaPickerViewCallback.callback(provinceSelected);
            }
        });
        cityBeans = new ArrayList<>();
        cityAdapter = new CityAdapter(R.layout.item_dialog_address, cityBeans);
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if (cityBeans.get(position).getChildren() != null) {
                    ...
                    if (strings.size() == 2) {
                        ...
                        strings.set(3, context.getResources().getString(R.string.please_choose));
                    }
                    tabLayout.setupWithViewPager(viewPager);
                    viewPagerAdapter.notifyDataSetChanged();
        ...
        areaAdapter = new AreaAdapter(R.layout.item_dialog_address, areaBeans);
...
*/
        ...
        villageAdapter = new VillageAdapter(R.layout.item_dialog_address, villageBeans);
        ...
        villageAdapter.setOnItemClickListener(new OnItemClickListener() {
            @Override
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
    ...
    public void updateData(List<AddressBean> addressBeans, int index) {
        this.addressBeans = addressBeans;
        switch (index) {
            case 1:
                if (provinceAdapter != null) {
                    provinceAdapter.setList(addressBeans);
//                    provinceAdapter.notifyDataSetChanged();
                }
                break;
            case 2:
                if (cityAdapter != null) {
                    cityAdapter.setList(addressBeans.get(provinceSelected).getChildren());
//                    cityAdapter.notifyDataSetChanged();
                } break;
            case 3:
                if (areaAdapter != null) {
                    areaAdapter.setList(addressBeans.get(provinceSelected).getChildren().get(citySelected).getChildren());
//                    areaAdapter.notifyDataSetChanged();
                } break;
            case 4:
