...
class VaryViewHelperController private constructor(private val helper: VaryViewHelper) :
    ...
    override fun showLoading() {
        hasRestore = false
        val layout = helper.inflate(R.layout.base_page_loading)
    ...
    override fun showEmpty(emptyMsg: String?) {
        hasRestore = false
        val layout = helper.inflate(R.layout.base_page_no_data)
    ...
    override fun showEmpty(
        ...
        hasRestore = false
        val layout = helper.inflate(R.layout.base_page_no_data_click)
        val againBtn =
    ...
    override fun showNetworkError(
        ...
        hasRestore = false
        val layout = helper.inflate(R.layout.base_page_error)
        val againBtn =
            layout.findViewById<Button>(R.id.pager_error_loadingAgain)
